<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StitchOrder.aspx.cs" Inherits="StitchOrder" %>
                                ...
                                <form id="Form1" runat="server">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label for="fname" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Nama:</label>
                                            <input type="text" name="fname" id="fname" class="form-control" value="<%=sName %>" />
                                        </div>
                                        <div class="form-group">
                                            <label for="datefrom" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Tarikh Tempahan Ukuran [Dari]:</label>
                                            <input type="text" id="datefrom" class="date-picker form-control" name="datefrom" value="<%=sStartDate %>" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label for="fnokp" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">No. K/P:</label>
                                            <input type="text" name="fnokp" id="fnokp" class="form-control" value="<%=sNoKP %>" />
                                        </div>
                                        <div class="form-group">
                                            <label for="dateto" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Tarikh Tempahan Ukuran [Hingga]:</label>
                                            <input type="text" id="dateto" class="date-picker form-control" name="dateto" value="<%=sEndDate %>" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label for="ftelno" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">No. Telefon:</label>
                                            <input type="text" name="ftelno" id="ftelno" class="form-control" value="<%=sTelNo %>" />
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                        <div class="form-group">
                                            ...
                                            <button type="button" onclick="actionclick('ADD');" class="btn btn-success" data-toggle="modal" data-target=".modal-new-stitch">Daftar</button>
