<%@ Page Title="" Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" CodeFile="OrderListing.aspx.cs" Inherits="OrderListing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Pesanan Jualan <small>SENARAI</small></h2>
    ...
    <script type="text/javascript">
        ...
        function openaddneworder() {
            var popupWindow = window.open("OrderDetails.aspx?action=ADD", "add_order", "toolbar=0,location=0,status=1,menubar=0,resizable=1,scrollbars=1,width=1000,height=800");
            if (popupWindow == null) {
