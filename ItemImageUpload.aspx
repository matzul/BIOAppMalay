<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemImageUpload.aspx.cs" Inherits="ItemImageUpload" %>
    ...
    <div class="section section--head">
        ...
        <div class="row">
            <div id="demo-test-gallery" class="demo-gallery">
                ...
                <a href='./Attachment/<%=itemImage.GetSetfilename %>' data-author="<%=itemImage.GetSetfilename %>" data-size='<%=itemImage.GetSetimgwidth %>x<%=itemImage.GetSetimgheight %>' data-med='./Attachment/<%=itemImage.GetSetfilename %>' data-med-size='<%=itemImage.GetSetimgwidth %>x<%=itemImage.GetSetimgheight %>' <%=i.Equals(0)?"class='demo-gallery__img--main'":"" %>>
                    <img src='./Attachment/<%=itemImage.GetSetfilename %>' alt='' />
                ...
                $.ajax({
                    ...
                    success: function (data, status, xmlData) {
                        ...
                        if (result.status == 'Y') {
                            ...
                            window.location.href = "ItemImageUpload.aspx?action=OPEN&itemno=<%=sItemNo %>";
                        }
                        else {
