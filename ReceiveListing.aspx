<%@ Page Title="" Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" CodeFile="ReceiveListing.aspx.cs" Inherits="ReceiveListing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Pesanan Terimaan <small>SENARAI</small></h2>
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form id="search" runat="server">
                                    ...
                                    <div class="form-group">
                                        <label for="bpdid" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Pembekal:</label>
                      ...
                      <tbody>
                        ...
                        %>       
                            <tr class="even pointer">
                              ...
                              <td><%=modOrdHdr.GetSetplandeliverydate %></td>
    ...
    <script type="text/javascript">
        ...
        function openaddneworder() {
            var popupWindow = window.open("ReceiveDetails.aspx?action=ADD", "add_purchase", "toolbar=0,location=0,status=1,menubar=0,resizable=1,scrollbars=1,width=1000,height=800");
            if (popupWindow == null) {
        ...
        function openeditorder(comp,orderno) {
            var popupWindow = window.open("ReceiveDetails.aspx?action=OPEN&comp="+comp+"&orderno="+orderno, "open_purchase", "toolbar=0,location=0,status=1,menubar=0,resizable=1,scrollbars=1,width=1000,height=800");
            if (popupWindow == null) {
                alert("Error: While Launching Session Expiry screen.\nYour browser maybe blocking up Popup windows.\nPlease check your Popup Blocker Settings");
            } else {
                wleft = (screen.width - 1000) / 2;
