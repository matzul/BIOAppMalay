<%@ Page Title="" Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" CodeFile="ReceiveReport.aspx.cs" Inherits="ReceiveReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Pesanan Terimaan <small>LAPORAN</small></h2>
    ...
    <script type="text/javascript">
        function openeditorder(comp, orderno) {
            var popupWindow = window.open("ReceiveDetails.aspx?action=OPEN&comp=" + comp + "&orderno=" + orderno, "open_receive", "toolbar=0,location=0,status=1,menubar=0,resizable=1,scrollbars=1,width=1000,height=800");
            if (popupWindow == null) {
