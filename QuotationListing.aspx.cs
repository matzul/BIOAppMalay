...
public partial class QuotationListing : System.Web.UI.Page
{
    ...
    private void processValues()
    {
        ...
        {
            lsOrderHeader = oMainCon.getQuotationHeaderList(sCurrComp, sOrderNo, "SALES_ORDER", sBPID, sStartDate, sEndDate, sStatus);
        }
    }
