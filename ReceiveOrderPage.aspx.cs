...
public partial class ReceiveOrderPage : System.Web.UI.Page
{
    ...
    private void generatePDFFile()
    {
        ...
        doc.Info.Title = "PESANAN TERIMAAN";
        ...
        header.AddText("PESANAN TERIMAAN");
        ...
        */
        ...
        rowTblBtm.Borders.Top.Visible = false;
        rowTblBtm.Borders.Bottom.Visible = false;
        rowTblBtm.Cells[0].AddParagraph("1. Pesanan Terimaan ini sah sehingga tiga(3) bulan dari tarikh ia dikeluarkan.");
        rowTblBtm.Cells[0].MergeRight = 2;
        ...
        rowTblBtm.Borders.Top.Visible = false;
        rowTblBtm.Borders.Bottom.Visible = false;
        rowTblBtm.Cells[0].AddParagraph("2. Sila pastikan Pesanan Terimaan ini ditandatangani sebelum salinan dikembalikan ke Pejabat Perolehan.");
        rowTblBtm.Cells[0].MergeRight = 2;
