<%@ Page Title="" Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" CodeFile="AssetPlacement.aspx.cs" Inherits="AssetPlacement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Penempatan Aset <small>SENARAI</small></h2>
                  ...
                  <div class="x_content table-responsive">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <tbody>
                        ...
                        %>       
                        <tr>
                          <td><a href="#" class="btn-link" onclick="openassetplacement('<%=modAsset.GetSetcomp %>','<%=modAsset.GetSetassetno %>');"><i class="glyphicon glyphicon-play"></i></a></td>
                          <td><a href="#" class="btn-link" onclick="openassetplacement('<%=modAsset.GetSetcomp %>','<%=modAsset.GetSetassetno %>');"><%=modAsset.GetSetassetno %></a></td>
    ...
    <script type="text/javascript">
        var currflag = false;
        function enabledisablesearchbox(currflag) {
        ...
        function openassetplacement(comp, assetno) {
            var popupWindow = window.open("AssetPlacementDetails.aspx?action=OPEN&comp=" + comp + "&assetno=" + assetno , "open_asset", "toolbar=0,location=0,status=1,menubar=0,resizable=1,scrollbars=1,width=1000,height=800");
            if (popupWindow == null) {
