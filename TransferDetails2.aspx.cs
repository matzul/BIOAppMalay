...
public partial class TransferDetails2 : System.Web.UI.Page
{
    ...
    private void getValues()
    {
        ...
        else if (sAction.Equals("INSERT") || sAction.Equals("UPDATE"))
        {
            ...
            if (oModLineItem.GetSetitemno.Trim().Length > 0)
            {
                oModLineItem.GetSetitemno = oMainCon.replaceNull(Request.Params.Get("hidItemNo"));
                oModLineItem.GetSetlocation = oMainCon.replaceNull(Request.Params.Get("hidLocation"));
                oModLineItem.GetSetdatesoh = oMainCon.replaceNull(Request.Params.Get("hidDateSOH"));
            }
    ...
    private void processValues()
    {
        ...
        //Comment out for a while - using new approach GeneralHandler
