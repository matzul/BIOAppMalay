<%@ Page Title="" Language="C#" MasterPageFile="~/HumanResource/MasterPageAttendanceChild.master" AutoEventWireup="true" CodeFile="AttendanceWorkingStaffDay.aspx.cs" Inherits="HumanResource_AttendanceWorkingStaffDay" %>
        ...
        <form id="form1" runat="server">
            ...
            <table id="mytable" width="98%" border="0" cellspacing="1" cellpadding="2" class="tblBg fixed_header" align="center">
                <tbody>
                    ...
                    <tr data-depth="1" class="level1 <%=boolrestday.Equals(true)?"tblTitle2":boolphday.Equals(true)?"hilite1":"tblText1" %>" data-id="<%=modWorkStaffDay.GetSetid %>">
                        <td valign="top" align="left"></td>
                        <td valign="top" align="left"><%=modWorkStaffDay.GetSetdesc %> [<%=modWorkStaffDay.GetSetcode %>]</td>
                        <td valign="top" align="left"><%=modWorkStaffDay.GetSetday_date %></td>
                        <td valign="top" align="left"><%=modWorkStaffDay.GetSetday_name %></td>
                        <td valign="top" align="left"><%=modWorkStaffDay.GetSetfromtime %></td>
                        <td valign="top" align="left"><%=modWorkStaffDay.GetSettotime %><br /><%=modWorkStaffDay.GetSetnext_day.Equals("1")?"(Hari Berikut)":"" %></td>
