...
public partial class ReceiveListing : System.Web.UI.Page
{
    ...
    private void processValues()
    {
        ...
        {
            lsOrderHeader = oMainCon.getPurchaseOrderHeaderList(sCurrComp, sOrderNo, "RECEIVE_ORDER", sBPID, sStartDate, sEndDate, sStatus);
        }
    }
