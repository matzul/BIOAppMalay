...
public partial class PurchaseDetails : System.Web.UI.Page
{
    ...
    private void processValues()
    {
        if (sAction.Equals("ADD"))
        {
            sActionString = "DAFTAR PESANAN BELIAN";
        }
        else if (sAction.Equals("CREATE"))
        {
            if (sOrderNo.Length > 0)
            {
                ...
                if (oMainCon.insertPurchaseOrderHeader(oModOrder).Equals("Y"))
                {
                    ...
                    lsOrderLineItem = new ArrayList();
                    sAlertMessage = "SUCCESS|Daftar maklumat Pesanan Belian berjaya...";
                    Response.Redirect("PurchaseDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
                else
                {
                    sAlertMessage = "ERROR|Daftar maklumat Pesanan Belian tidak berjaya...";
                    sOrderNo = "";
                    oModOrder.GetSetorderno = sOrderNo;
                    sAction = "ADD";
                    sActionString = "DAFTAR PESANAN BELIAN";
        ...
        {
            sActionString = "MAKLUMAT PESANAN BELIAN";
            if (sOrderNo.Length > 0)
            {
                oModOrder = oMainCon.getPurchaseOrderHeaderDetails(sCurrComp, sOrderNo);
            ...
            {
                sAlertMessage = "ERROR|Tidak dapat membuka maklumat Pesanan Belian...";
                oModOrder = new MainModel();
                lsOrderLineItem = new ArrayList();
            }
        }
        ...
        {
            sActionString = "KEMASKINI PESANAN BELIAN";
            if (sOrderNo.Length > 0)
            {
                oModOrder = oMainCon.getPurchaseOrderHeaderDetails(sCurrComp, sOrderNo);
                lsOrderLineItem = oMainCon.getPurchaseOrderDetailsList(sCurrComp, sOrderNo, 0, "");
            ...
            {
                sAlertMessage = "ERROR|Tidak dapat mengemaskini maklumat Pesanan Belian...";
                oModOrder = new MainModel();
                lsOrderLineItem = new ArrayList();
            }
        }
        else if (sAction.Equals("SAVE"))
        {
            if (sOrderNo.Length > 0)
            {
                ...
                {
                    sAlertMessage = "SUCCESS|Maklumat Pesanan Belian berjaya disimpan...";
                    Response.Redirect("PurchaseDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
                else
                {
                    sAlertMessage = "ERROR|Maklumat Pesanan Belian tidak berjaya disimpan...";
                    sAction = "EDIT";
                    sActionString = "KEMASKINI PESANAN BELIAN";
                    oModOrder = oMainCon.getPurchaseOrderHeaderDetails(sCurrComp, sOrderNo);
                    lsOrderLineItem = oMainCon.getPurchaseOrderDetailsList(sCurrComp, sOrderNo, 0, "");
            ...
            if (sOrderNo.Length > 0 && oModLineItem.GetSetlineno > 0)
            {
                ...
                else
                {
                    ...
                    if (oMainCon.insertPurchaseOrderDetails(oModLineItem).Equals("Y"))
                    {
                        ...
                        sAlertMessage = "SUCCESS|Item Belian berjaya ditambah...";
                        Response.Redirect("PurchaseDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                    }
                    else
                    {
                        sAlertMessage = "ERROR|Item Belian tidak berjaya ditambah...";
                        Response.Redirect("PurchaseDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                    }
                }
            }
        ...
        else if (sAction.Equals("UPDATE"))
        {
            if (sOrderNo.Length > 0 && oModLineItem.GetSetlineno > 0)
            {
                ...
                if (oMainCon.updatePurchaseOrderDetails(oModLineItem).Equals("Y"))
                {
                    ...
                    String result = oMainCon.updatePurchaseOrderHeaderInfo(sCurrComp, sOrderNo);
                    sAlertMessage = "SUCCESS|Item Belian berjaya dikemaskini...";
                    Response.Redirect("PurchaseDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
                else
                {
                    sAlertMessage = "ERROR|Item Belian tidak berjaya dikemaskini...";
                    Response.Redirect("PurchaseDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
            }
            else
        ...
        else if (sAction.Equals("DELETE"))
        {
            if (sOrderNo.Length > 0 && oModLineItem.GetSetlineno > 0)
            {
                ...
                if (oMainCon.deletePurchaseOrderDetails(oModLineItem).Equals("Y"))
                {
                    ...
                    //update purchase order header information
                    String result = oMainCon.updatePurchaseOrderHeaderInfo(sCurrComp, sOrderNo);
                    sAlertMessage = "SUCCESS|Item Belian berjaya dikeluarkan...";
                    Response.Redirect("PurchaseDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
                else
                {
                    sAlertMessage = "ERROR|Item Belian tidak berjaya dikeluarkan...";
                    Response.Redirect("PurchaseDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
            }
            else
            ...
            if (sOrderNo.Length > 0 && oMainCon.getPurchaseOrderHeaderDetails(sCurrComp, sOrderNo).GetSetorderstatus != "CONFIRMED" && oMainCon.getPurchaseOrderHeaderDetails(sCurrComp, sOrderNo).GetSetorderstatus != "CANCELLED")
            {
                ...
                if (proceedConfirmOrder)
                {
                    if (oMainCon.updatePurchaseOrderHeader(oModOrder).Equals("Y"))
                    {
                        ...
                        //update purchase order header information
                        sAlertMessage = "SUCCESS|Maklumat Pesanan Belian berjaya disahkan...";
                        Response.Redirect("PurchaseDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                    }
                    else
                    {
                        sAlertMessage = "ERROR|Maklumat Pesanan Belian tidak berjaya disahkan...";
                        Response.Redirect("PurchaseDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                    }
                }
                else
        ...
        else if (sAction.Equals("CANCEL"))
        {
            if (sOrderNo.Length > 0)
            {
                ...
                {
                    //update purchase order header information
                    sAlertMessage = "SUCCESS|Maklumat Pesanan Belian berjaya dibatalkankan...";
                    Response.Redirect("PurchaseDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
                else
                {
                    sAlertMessage = "ERROR|Maklumat Pesanan Belian tidak berjaya dibatalkankan...";
                    Response.Redirect("PurchaseDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
            }
            else
