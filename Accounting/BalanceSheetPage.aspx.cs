...
public partial class Accounting_BalanceSheetPage : System.Web.UI.Page
{
    ...
    public ArrayList lsBalanceSheet = new ArrayList();
    ...
    private void processValues()
    {
        ...
        if (lsFisBalance.Count == 1)
        {
            ...
            modItem.GetSetitemtype = "CURRENT_BALANCE_SHEET";
            modItem.GetSetitemtypedesc = "Laporan Penyata Kedudukan Kewangan Semasa";
        ...
        else 
        {
            ...
            for(int i=0; i<lsFisBalance.Count; i++)
            {
                ...
                {
                    modItem.GetSetitemtype = "CLOSED_BALANCE_SHEET";
                    modItem.GetSetitemtypedesc = "Laporan Penyata Kedudukan Kewangan Bagi Penutupan Baki Akaun " + modItem.GetSettrandate;
