...
public partial class Accounting_CashEntryPage : System.Web.UI.Page
{
    ...
    private void processValues()
    {
        ...
        if (sAction.Equals("SAVE"))
        {
            ...
            modJournalTran.GetSettrancat = sCurrTranCat;
            modJournalTran.GetSetfyr = sCurrFyr;
    ...
    private void getValues()
    {
        ...
        if (Request.Params.Get("lsFindTranCat") != null)
        {
            sCurrTranCat = oAccCon.replaceNull(Request.Params.Get("lsFindTranCat"));
        }
    ...
    [WebMethod(EnableSession = true)]
    public static String getFisCOATranList(string currcomp, string fyr, string acctype, string acccat)
    {
        AccountingController oAccCon = new AccountingController();
        String sUserId = "";
        String sStatus = "N";
        ...
        if (currcomp.Length > 0)
        {
            ArrayList lsFisCOAMaster = oAccCon.getFisCOATranList(currcomp, fyr, "", "", "", "Y", acctype, acccat, "", "", "");
            for (int i = 0; i < lsFisCOAMaster.Count; i++)
            {
                AccountingModel oAccMod = (AccountingModel)lsFisCOAMaster[i];
