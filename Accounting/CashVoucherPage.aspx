<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/MasterPageAccounting.master" AutoEventWireup="true" CodeFile="CashVoucherPage.aspx.cs" Inherits="Accounting_CashVoucherPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="contentfolder">
        ...
        <table width="98%" border="0" cellspacing="1" cellpadding="5" align="center">
            <tr>
                <td align="center" valign="top" ><a href="#" class="activeTab tab">Baucar Tunai / Cash Voucher (CV)</a></td>
            </tr>
        </table>
        ...
        <table width="98%" border="0" cellspacing="1" cellpadding="5" align="center">
            <tr>
                <td align="center" valign="top" ><a href="#" class="activeTab tab">Senarai Transaksi Baucar Tunai / List of Cash Voucher Transaction</a></td>
            </tr>
        </table>
        ...
        <table id="mytable" width="98%" border="0" cellspacing="1" cellpadding="2" class="tblBg fixed_header" align="center">
                <tbody>
                    ...
                    <tr data-id="<%=modAcc.GetSettrancode %>_<%=modAcc.GetSettranno %>_<%=i+1 %>" class="tblText1">
                        ...
                        <td valign="top" align="left"><%=modAcc.GetSettrancat %></td>
                    ...
                    <tr data-id="<%=modAcc.GetSettrancode %>_<%=modAcc.GetSettranno %>_<%=i+1 %>" class="tblText1">
                        <td data-id="" colspan="10" class="tblText2">
                            <button type="button" class="button_warning enabled" onclick="fOpenWindow('CashEntryPage.aspx?fyr=<%=sCurrFyr %>&action=OPEN&tranno=<%=modAcc.GetSettranno %>&trancode=<%=modAcc.GetSettrancode %>');"><%=modAcc.GetSetstatus.Equals("CONFIRMED")?"Lihat":"Kemaskini" %></button>
	        ...
	        <table width="98%" border="0" cellpadding="2" cellspacing="1" align="center" id="tblParentButton">
			    <tr>
				    <td align="center">
                        <input class="button1a" id="btnAdd" name="btnAdd" type="button" value="Daftar Baucar" onclick="fOpenWindow('CashEntryPage.aspx?fyr=<%=sCurrFyr %>&action=ADD&tranno=&trancode=<%=sTranCode%>');">
