<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/MasterPageAccountingChild.master" AutoEventWireup="true" CodeFile="TrialBalanceDetailsPage.aspx.cs" Inherits="Accounting_TrialBalanceDetailsPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="contentfolder">
        <form id="form1" runat="server">
            ...
            <table width="98%" border="0" cellspacing="1" cellpadding="5" align="center" style="border-spacing: 1px; border-collapse: inherit;">
                <tr>
                    <td align="center" valign="top"><a href="#" class="activeTab tab">Penyata Imbangan lejer / Trial Balance Ledger</a></td>
                </tr>
            </table>
            ...
            <table width="98%" border="0" cellspacing="1" cellpadding="5" align="center" style="border-spacing: 1px; border-collapse: inherit;">
                <tr>
                    <td align="center" valign="top"><a href="#" class="activeTab tab">Senarai Transaksi Imbangan lejer / List of Trial Balance Ledger Transaction</a></td>
                </tr>
            </table>
            <table id="mytable" width="98%" border="0" cellspacing="1" cellpadding="2" class="tblBg fixed_header" align="center">
                <tbody>
                    ...
                    <%
                        if (lsTrailBalanceDetails.Count > 0)
                        {
                            for (int i = 0; i < lsTrailBalanceDetails.Count; i++)
                            {
                                AccountingModel modAcc = (AccountingModel)lsTrailBalanceDetails[i];
                                dTotalDebit = Math.Round(dTotalDebit + modAcc.GetSetdebit,2);
                                dTotalCredit = Math.Round(dTotalCredit + modAcc.GetSetcredit,2);
                    %>
                ...
                <tr>
                    <td>
                        <table width="100%" cellpadding="2" cellspacing="1" class="tblTextMod">
                            <tr>
                                <td width="50%" height="15" align="left"><%=lsTrailBalanceDetails.Count %> record(s)</td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            document.getElementById("txtFindBalance").value = "<%=dTotalDebit - dTotalCredit%>";
        });
