...
public partial class Accounting_InvoiceIssuedPage : System.Web.UI.Page
{
    ...
    public ArrayList lsInvoiceIssued = new ArrayList();
    public ArrayList lsInvoiceNo = new ArrayList();
    ...
    private void processValues()
    {
        ...
        lsInvoiceIssued = oMainCon.getInvoiceHeaderDetailsList(sCurrComp, sCurrFyr, sCurrInvoiceNo, "", datetime1.ToString(), datetime2.ToString(), "", "CONFIRMED", "");
    ...
    private void getValues()
    {
        ...
        {
            sCurrInvoiceNo = oAccCon.replaceNull(Request.Params.Get("txtFindInvoiceNo"));
        }
    ...
    [WebMethod(EnableSession = true)]
    public static String getInvoiceList(string currcomp, string fyr)
    {
        MainController oMainCon = new MainController();
        String sUserId = "";
        String sStatus = "N";

        ArrayList lsInvoiceNo = new ArrayList();
        ...
        if (currcomp.Length > 0)
        {
            ArrayList lsInvoice = oMainCon.getInvoiceHeaderList(currcomp, "", "", "01-01-" + fyr, "31-12-" + fyr, "CONFIRMED");
            for (int i = 0; i < lsInvoice.Count; i++)
            {
                ...
                Object objData = new
                {
                    GetSetinvoiceno = oMod.GetSetinvoiceno,
                    GetSetbpdesc = oMod.GetSetbpdesc + " [" + oMod.GetSettotalamount + "]"
                };
                lsInvoiceNo.Add(objData);
            }
            sStatus = "Y";
        }

        object retData = new { result = sStatus, invoicelist = lsInvoiceNo };
