<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/MasterPageAccounting.master" AutoEventWireup="true" CodeFile="JournalVoucherPage.aspx.cs" Inherits="Accounting_JournalVoucherPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="contentfolder">
        ...
        <table width="98%" border="0" cellspacing="1" cellpadding="5" align="center">
            <tr>
                <td align="center" valign="top" ><a href="#" class="activeTab tab">Baucar Jurnal / Journal Voucher (JV)</a></td>
            </tr>
        </table>
        ...
        <table width="98%" border="0" cellspacing="1" cellpadding="5" align="center">
            <tr>
                <td align="center" valign="top" ><a href="#" class="activeTab tab">Senarai Transaksi Baucar Jurnal / List of Journal Voucher Transaction</a></td>
            </tr>
        </table>
