...
public partial class Accounting_TrialBalancePage : System.Web.UI.Page
{
    ...
    public ArrayList lsTrialBalance = new ArrayList();
    ...
    private void processValues()
    {
        ...
        if (lsFisBalance.Count == 1)
        {
            ...
            modItem.GetSetitemtype = "CURRENT_TRIAL_BALANCE";
            modItem.GetSetitemtypedesc = "Laporan Penyata Imbangan Semasa";
        ...
        else 
        {
            ...
            for(int i=0; i<lsFisBalance.Count; i++)
            {
                ...
                {
                    modItem.GetSetitemtype = "CLOSED_TRIAL_BALANCE";
                    modItem.GetSetitemtypedesc = "Laporan Penyata Imbangan Bagi Penutupan Baki Akaun " + modItem.GetSettrandate;
