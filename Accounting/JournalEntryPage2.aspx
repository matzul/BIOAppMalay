<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/MasterPageAccountingChild.master" AutoEventWireup="true" CodeFile="JournalEntryPage2.aspx.cs" Inherits="Accounting_JournalEntryPage2" %>
        ...
        <form id="form1" runat="server">
            ...
            <table id="mytable" width="98%" border="0" cellspacing="1" cellpadding="2" class="tblBg fixed_header" align="center" style="border-spacing: 1px; border-collapse: inherit;">
                <tbody>
                    ...
                    %>
                    <tr data-id="<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1" class="tblText1">
                        <td data-id="<%=modJournalTran.GetSetrefno %>" colspan="10" class="tblText2">
                            <div class="Table">
                                <div class="Heading">
                                    <div class="Cell">
                                        No. Lejer
