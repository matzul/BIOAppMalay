<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/MasterPageAccountingChild.master" AutoEventWireup="true" CodeFile="CashEntryPage.aspx.cs" Inherits="Accounting_CashEntryPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <form id="form1" runat="server">
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="tblBg" style="border-spacing: 1px; border-collapse: inherit;">
                ...
                <tr>
                    ...
                    <td width="80%" class="tblText2">
                        <select class="select disabled" id="lsFindTranCode" name="lsFindTranCode" disabled>
                            ...
                            <option value="BANK_VOUCHER" <%=modJournalTran.GetSettrancode.Equals("BANK_VOUCHER") ? "selected" : "" %>>BAUCAR BANK</option>
                ...
                <tr>
                    ...
                    <td width="80%" class="tblText2">
                        <select class="select <%=modJournalTran.GetSetstatus.Equals("CONFIRMED") ? "disabled" : ""%>" id="lsFindTranCat" name="lsFindTranCat" <%=modJournalTran.GetSetstatus.Equals("CONFIRMED") ? "disabled" : ""%> >
                            <option value="PAYMENT" <%=modJournalTran.GetSettrancat.Equals("PAYMENT") ? "selected" : "" %>>BAYARAN</option>
                            <option value="RECEIPT" <%=modJournalTran.GetSettrancat.Equals("RECEIPT") ? "selected" : "" %>>TERIMAAN</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="80%" class="tblText2">
                        <textarea id="txtFindTranDesc" class="textarea" name="txtFindTranDesc" cols="35" rows="2" <%=modJournalTran.GetSetstatus.Equals("CONFIRMED") ? "disabled" : ""%>><%=modJournalTran.GetSettrandesc %></textarea>
                    </td>
                </tr>
            ...
            <table id="mytable" width="98%" border="0" cellspacing="1" cellpadding="2" class="tblBg fixed_header" align="center" style="border-spacing: 1px; border-collapse: inherit;">
                <tbody>
                    <tr class="tblTitle3Mod">
                        ...
                        <td width="8%" valign="middle" align="left" class="tblTitle3Mod">Kategori</td>
                    ...
                    <tr data-id="<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1" class="tblText1">
                        ...
                        <td valign="top" align="left"><%=modJournalTran.GetSettrancat %></td>
                    ...
                    <tr data-id="<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1" class="tblText1">
                        <td data-id="<%=modJournalTran.GetSetrefno %>" colspan="11" class="tblText2">
                            ...
                            <script type="text/javascript">
                                ...
                                if ("<%=modJournalTran.GetSettrancode%>" == "CASH_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "RECEIPT"  && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=j+1%>').val() == "1") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=j+1%> = "TRAN";
                                } else if ("<%=modJournalTran.GetSettrancode%>" == "CASH_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "PAYMENT"  && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=j+1%>').val() == "2") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=j+1%> = "TRAN";
                                } else if ("<%=modJournalTran.GetSettrancode%>" == "BANK_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "RECEIPT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=j+1%>').val() == "1") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=j+1%> = "TRAN";
                                } else if ("<%=modJournalTran.GetSettrancode%>" == "BANK_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "PAYMENT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=j+1%>').val() == "2") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=j+1%> = "TRAN";
                                } else {
                            ...
                            <script type="text/javascript">
                                ...
                                if ("<%=modJournalTran.GetSettrancode%>" == "CASH_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "RECEIPT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=iTotalLine %>').val() == "1") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=iTotalLine %> = "TRAN";
                                } else if ("<%=modJournalTran.GetSettrancode%>" == "CASH_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "PAYMENT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=iTotalLine %>').val() == "2") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=iTotalLine %> = "TRAN";
                                } else if ("<%=modJournalTran.GetSettrancode%>" == "BANK_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "RECEIPT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=iTotalLine %>').val() == "1") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=iTotalLine %> = "TRAN";
                                } else if ("<%=modJournalTran.GetSettrancode%>" == "BANK_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "PAYMENT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=iTotalLine %>').val() == "2") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_<%=iTotalLine %> = "TRAN";
                                } else {
                            ...
                            <script type="text/javascript">
                                ...
                                if ("<%=modJournalTran.GetSettrancode%>" == "CASH_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "RECEIPT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_2').val() == "1") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_2 = "TRAN";
                                } else if ("<%=modJournalTran.GetSettrancode%>" == "CASH_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "PAYMENT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_2').val() == "2") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_2 = "TRAN";
                                } else if ("<%=modJournalTran.GetSettrancode%>" == "BANK_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "RECEIPT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_2').val() == "1") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_2 = "TRAN";
                                } else if ("<%=modJournalTran.GetSettrancode%>" == "BANK_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "PAYMENT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_2').val() == "2") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_2 = "TRAN";
                                } else {
                            ...
                            <script type="text/javascript">
                                ...
                                if ("<%=modJournalTran.GetSettrancode%>" == "CASH_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "RECEIPT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_1').val() == "1") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_1 = "TRAN";
                                } else if ("<%=modJournalTran.GetSettrancode%>" == "CASH_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "PAYMENT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_1').val() == "2") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_1 = "TRAN";
                                } else if ("<%=modJournalTran.GetSettrancode%>" == "BANK_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "RECEIPT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_1').val() == "1") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_1 = "TRAN";
                                } else if ("<%=modJournalTran.GetSettrancode%>" == "BANK_VOUCHER" && "<%=modJournalTran.GetSettrancat%>" == "PAYMENT" && $('#selaccledger_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_1').val() == "2") {
                                    selectcoa_<%=modJournalTran.GetSettrancode %>_<%=modJournalTran.GetSettranno %>_1_1 = "TRAN";
                                } else {
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if ("<%=modJournalTran.GetSettrancode%>" == "CASH_VOUCHER") {
                acctype = "A";
                acccat = "CASH"
            } else if ("<%=modJournalTran.GetSettrancode%>" == "BANK_VOUCHER") {
                acctype = "A";
                acccat = "BANK"
            } else {
                acctype = "";
            ...
            var getFisCOAList_parameters = ["currcomp", "<%=sCurrComp%>", "fyr", "<%=sCurrFyr%>", "acctype", "", "acccat", ""];
            PageMethod("getFisCOATranList", getFisCOAList_parameters, getFisCOAList_succeedAjaxFn, getFisCOAList_failedAjaxFn, false);

            var getFisCOATranList_parameters = ["currcomp", "<%=sCurrComp%>", "fyr", "<%=sCurrFyr%>", "acctype", acctype, "acccat", acccat];
