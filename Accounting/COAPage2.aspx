<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/MasterPageAccounting.master" AutoEventWireup="true" CodeFile="COAPage2.aspx.cs" Inherits="Accounting_COAPage2" %>
    ...
    <div class="contentfolder">
        <form id="form1" runat="server">
            ...
            <table id="mytable" width="98%" border="0" cellspacing="1" cellpadding="2" class="tblBg fixed_header" align="center">
                <thead>
                    <tr class="tblTitle3Mod">
                        <td height="20" width="20%" valign="middle" align="left" class="tblTitle3Mod">No. Koding</td>
                        <td width="25%" align="left" valign="middle" class="tblTitle3Mod">Nama Koding</td>
                ...
                <tbody>
                    ...
                    %>
                    <tr data-depth="<%=modAcc.GetSetacclevel %>" class="<%=lsFisAccId.Contains(modAcc.GetSetaccid)?"expand":"collapse"%> level<%=modAcc.GetSetacclevel %> tblText1">
                        <td><%=modAcc.GetSetendlevel.Equals("Y")?"":lsFisAccId.Contains(modAcc.GetSetaccid)?"<span class='toggle expand'></span>":"<span class='toggle collapse'></span>" %><%=modAcc.GetSetaccid %></td>
                        <td><%=modAcc.GetSetaccdesc %></td>
                        <td><%=modAcc.GetSetaccnumber %></td>
                        <td><%=modAcc.GetSetfyr %></td>
                        <td><%=modAcc.GetSetaccgroup %></td>
                        <td><%=modAcc.GetSetacctype %></td>
                        <td><%=modAcc.GetSetparentid %></td>
                        <td><%=modAcc.GetSetdebit %></td>
                        <td><%=modAcc.GetSetcredit %></td>
                    </tr>
                    <%
                            }
                        }
        ...
        */
        ...
        function actionclick(action) {
            ...
            if (action == "RESET") {
                ...
                document.getElementById("lsFindFyr").selectedIndex = 0;
