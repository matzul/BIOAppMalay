<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/MasterPageAccounting.master" AutoEventWireup="true" CodeFile="TrialBalancePage.aspx.cs" Inherits="Accounting_TrialBalancePage" %>
    ...
    <div class="contentfolder">
        <form id="form1" runat="server">
            ...
            <table width="98%" border="0" cellspacing="1" cellpadding="5" align="center" style="border-spacing: 1px; border-collapse: inherit;">
                <tr>
                    <td align="center" valign="top"><a href="#" class="activeTab tab">Laporan Lembaran Imbangan / Trial Balance Report</a></td>
                </tr>
            </table>
            ...
            <table width="98%" border="0" cellspacing="1" cellpadding="5" align="center" style="border-spacing: 1px; border-collapse: inherit;">
                <tr>
                    <td align="center" valign="top"><a href="#" class="activeTab tab">Senarai Lembaran Imbangan / List of Trial Balance Report</a></td>
                </tr>
            </table>
            <table id="mytable" width="98%" border="0" cellspacing="1" cellpadding="2" class="tblBg fixed_header" align="center">
                <tbody>
                    ...
                    <%
                        if (lsTrialBalance.Count > 0)
                        {
                            for (int i = 0; i < lsTrialBalance.Count; i++)
                            {
                                AccountingModel modAcc = (AccountingModel)lsTrialBalance[i];
                    ...
                    <tr data-id="<%=modAcc.GetSetid %>" class="tblText1">
                        ...
                        <td valign="top" align="center">
                            <button type="button" data-action="open_trans" class="button_warning" onclick="openTrialBalanceDetails('OPEN','<%=modAcc.GetSetfyr %>','<%=modAcc.GetSetitemtype %>', '<%=modAcc.GetSetitemtypedesc %>','<%=modAcc.GetSetdatefrom %>', '<%=modAcc.GetSetdateto %>', '<%=modAcc.GetSetcurrency %>', '<%=modAcc.GetSetstatus %>');">Senarai Penyata Imbangan</button>
                        </td>
                    </tr>
                    <%
                            }
                ...
                <tr>
                    <td>
                        <table width="100%" cellpadding="2" cellspacing="1" class="tblTextMod">
                            <tr>
                                <td width="50%" height="15" align="left"><%=lsTrialBalance.Count %> record(s)</td>
