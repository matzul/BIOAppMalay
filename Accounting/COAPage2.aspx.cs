...
public partial class Accounting_COAPage2 : System.Web.UI.Page
{
    ...
    private void processValues()
    {
        sTotalPage = "1";
        sCurrentPage = "1";
        lsFisCOATran = oAccCon.getFisCOATranList(sCurrComp, sCurrFyr, "", "", "", 0, "", "", "", "", "");
        if (sCurrComp.Length > 0 && sCurrFyr.Length > 0 && sCurrAccId.Length > 0)
        {
