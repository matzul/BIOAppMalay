<%@ Page Title="" Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" CodeFile="PurchaseReport.aspx.cs" Inherits="PurchaseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Pesanan Belian <small>LAPORAN</small></h2>
                ...
                <div class="">
                    <form id="Form1" runat="server">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <label for="bpid" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Pembekal:</label>
                    ...
                    <table id="datatable-buttons" class="table table-striped jambo_table">
                        ...
                        <tbody>
                            ...
                            <tr class="even pointer">
                                ...
                                <td>
                                        <script type="text/javascript">
                                            var parameters = ["comp", "<%=modOrdHdr.GetSetcomp %>", "orderno", "<%=modOrdHdr.GetSetorderno %>", "itemno", "<%=modOrdHdr.GetSetitemno %>"];
                                ...
                                <td>
                                        <script type="text/javascript">
                                            var parameters = ["comp", "<%=modOrdHdr.GetSetcomp %>", "orderno", "<%=modOrdHdr.GetSetorderno %>", "itemno", "<%=modOrdHdr.GetSetitemno %>"];
                                            document.write(PageMethod("getExpensesNo", parameters, false));
                                        </script>
                                </td>
                                <td><%=modOrdHdr.GetSetbillingamount %></td>
