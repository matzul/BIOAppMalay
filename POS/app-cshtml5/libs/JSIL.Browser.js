...
function browserFinishedLoadingCallback (loadFailures) {
  ...
  try {     
    ...
    if (splashScreenContainerContainer)
        splashScreenContainerContainer.style.display = "none";
...
function generateHTML () {
  ...
  if (jsilConfig.showProgressBar) {
      var splashScreenContainerContainer = document.getElementById("splashScreenContainerContainer");
      if (splashScreenContainerContainer === null) {
          splashScreenContainerContainer = document.createElement("div");
          splashScreenContainerContainer.id = "splashScreenContainerContainer";
      }
      body.appendChild(splashScreenContainerContainer);

      var splashScreenContainer = document.getElementById("splashScreenContainer");
      if (splashScreenContainer === null) {
          splashScreenContainer = document.createElement("div");
          splashScreenContainer.id = "splashScreenContainer";
      }
      splashScreenContainerContainer.appendChild(splashScreenContainer);

      var splashScreenDiv = document.getElementById("splashScreen");
      if (splashScreenDiv === null) {
          splashScreenDiv = document.createElement("div");
          splashScreenDiv.id = "splashScreen";
      }
      splashScreenContainer.appendChild(splashScreenDiv);
    ...
    if (progressDiv === null) {
      ...
      var progressContainer = splashScreenContainer;
