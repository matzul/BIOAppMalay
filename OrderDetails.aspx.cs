...
public partial class OrderDetails : System.Web.UI.Page
{
    ...
    private void processValues()
    {
        if (sAction.Equals("ADD"))
        {
            sActionString = "DAFTAR PESANAN JUALAN";
        }
        else if (sAction.Equals("CREATE"))
        {
            if (sOrderNo.Length > 0)
            {
                ...
                if (oMainCon.insertOrderHeader(oModOrder).Equals("Y"))
                {
                    ...
                    lsOrderLineItem = new ArrayList();
                    sAlertMessage = "SUCCESS|Daftar maklumat Pesanan Jualan berjaya...";
                    Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
                else
                {
                    sAlertMessage = "ERROR|Daftar maklumat Pesanan Jualan tidak berjaya...";
                    sOrderNo = "";
                    oModOrder.GetSetorderno = sOrderNo;
                    sAction = "ADD";
                    sActionString = "DAFTAR PESANAN JUALAN";
        ...
        {
            sActionString = "MAKLUMAT PESANAN JUALAN";
            if (sOrderNo.Length > 0)
            {
                oModOrder = oMainCon.getOrderHeaderDetails(sCurrComp, sOrderNo);
            ...
            {
                sAlertMessage = "ERROR|Tidak dapat membuka maklumat Pesanan Jualan...";
                oModOrder = new MainModel();
                lsOrderLineItem = new ArrayList();
            }
        }
        ...
        {
            sActionString = "KEMASKINI PESANAN JUALAN";
            if (sOrderNo.Length > 0)
            {
                oModOrder = oMainCon.getOrderHeaderDetails(sCurrComp, sOrderNo);
                lsOrderLineItem = oMainCon.getOrderDetailsList(sCurrComp, sOrderNo, 0, "");
            ...
            {
                sAlertMessage = "ERROR|Tidak dapat mengemaskini maklumat Pesanan Jualan...";
                oModOrder = new MainModel();
                lsOrderLineItem = new ArrayList();
            }
        }
        else if (sAction.Equals("SAVE"))
        {
            if (sOrderNo.Length > 0)
            {
                ...
                {
                    sAlertMessage = "SUCCESS|Maklumat Pesanan Jualan berjaya disimpan...";
                    Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
                else
                {
                    sAlertMessage = "ERROR|Maklumat Pesanan Jualan tidak berjaya disimpan...";
                    sAction = "EDIT";
                    sActionString = "KEMASKINI PESANAN JUALAN";
                    oModOrder = oMainCon.getOrderHeaderDetails(sCurrComp, sOrderNo);
                    lsOrderLineItem = oMainCon.getOrderDetailsList(sCurrComp, sOrderNo, 0, "");
        ...
        else if (sAction.Equals("INSERT"))
        {
            if (sOrderNo.Length > 0 && oModLineItem.GetSetlineno > 0)
            {
                ...
                {
                    sAlertMessage = "ERROR|Item Jualan tidak berjaya ditambah. Item tersebut telah ditambah pada Pesanan Jualan [Line No: " + modExistent.GetSetlineno + "]";
                    Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
                else
                {
                    ...
                    if (oMainCon.insertOrderDetails(oModLineItem).Equals("Y"))
                    {
                        ...
                        sAlertMessage = "SUCCESS|Item Jualan berjaya ditambah...";
                        Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                    }
                    else
                    {
                        sAlertMessage = "ERROR|Item Jualan tidak berjaya ditambah...";
                        Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                    }
                }
            }
        ...
        else if (sAction.Equals("UPDATE"))
        {
            if (sOrderNo.Length > 0 && oModLineItem.GetSetlineno > 0)
            {
                ...
                if (oMainCon.updateOrderDetails(oModLineItem).Equals("Y"))
                {
                    //update order header information
                    String result = oMainCon.updateOrderHeaderInfo(sCurrComp, sOrderNo);
                    sAlertMessage = "SUCCESS|Item Jualan berjaya dikemaskini...";
                    Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
                else
                {
                    sAlertMessage = "ERROR|Item Jualan tidak berjaya dikemaskini...";
                    Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
            }
            else
        ...
        else if (sAction.Equals("DELETE"))
        {
            if (sOrderNo.Length > 0 && oModLineItem.GetSetlineno > 0)
            {
                ...
                if (oMainCon.deleteOrderDetails(oModLineItem).Equals("Y"))
                {
                    ...
                    //update order header information
                    String result = oMainCon.updateOrderHeaderInfo(sCurrComp, sOrderNo);
                    sAlertMessage = "SUCCESS|Item Jualan berjaya dikeluarkan...";
                    Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
                else
                {
                    sAlertMessage = "ERROR|Item Jualan tidak berjaya dikeluarkan...";
                    Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
            }
            else
            ...
            if (sOrderNo.Length > 0 && oMainCon.getOrderHeaderDetails(sCurrComp, sOrderNo).GetSetorderstatus != "CONFIRMED" && oMainCon.getOrderHeaderDetails(sCurrComp, sOrderNo).GetSetorderstatus != "CANCELLED")
            {
                ...
                if (oModOrder.GetSetorderactivity.Equals("ACTIVITY10"))
                {
                    if (stockAvailable)
                    {
                        ...
                        else
                        {
                            ...
                            sAlertMessage = "ERROR|Maklumat Pesanan Jualan tidak berjaya disahkan. Proses penghantaran tidak berjaya diteruskan [Internal Server Error]!";
                        }
                    }
                    else
                    {
                        proceedConfirmOrder = false;
                        sAlertMessage = "ERROR|Maklumat Pesanan Jualan tidak berjaya disahkan. Proses penghantaran tidak berjaya diteruskan [Inventori untuk sesetengah Item Jualan tiada stok]!";
                    }//if (stockAvailable)
                }
                ...
                if (proceedConfirmOrder)
                {
                    if (oMainCon.updateOrderHeader(oModOrder).Equals("Y"))
                    {
                        ...
                        //update order header information
                        sAlertMessage = "SUCCESS|Maklumat Pesanan Jualan berjaya disahkan...";
                        Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                    }
                    else
                    {
                        sAlertMessage = "ERROR|Maklumat Pesanan Jualan tidak berjaya disahkan...";
                        Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                    }
                }
                else
        ...
        else if (sAction.Equals("CANCEL"))
        {
            if (sOrderNo.Length > 0)
            {
                ...
                {
                    //update order header information
                    sAlertMessage = "SUCCESS|Maklumat Pesanan Jualan berjaya dibatalkankan...";
                    Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
                else
                {
                    sAlertMessage = "ERROR|Maklumat Pesanan Jualan tidak berjaya dibatalkankan...";
                    Response.Redirect("OrderDetails.aspx?action=OPEN&comp=" + sCurrComp + "&orderno=" + sOrderNo + "&alertmessage=" + sAlertMessage);
                }
            }
            else
