<%@ Page Title="" Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" CodeFile="Dashboard2.aspx.cs" Inherits="Dashboard2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <%if(sUserType.Equals("00")){ %>
          <div class="col-md-12 col-sm-12 col-xs-12">
              <a class="btn btn-dark" data-toggle="modal" data-target=".modal-update-dashboard">Update Dashboard</a>
          </div>
        <%} %>
          <!-- top tiles -->
          <div class="row tile_count">
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top dark"><i class="glyphicon glyphicon-import blue"></i> REVENUE PLAN (RM)</span>
              <div class="count blue"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModRevenuePlan.GetSetTODATE)) %></div>
              <span class="count_bottom">To Date [<%=sCurrFyr %>]</span>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top dark"><i class="glyphicon glyphicon-import green"></i> REVENUE ACTUAL (RM)</span>
              <div class="count green"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModRevenueActual.GetSetTODATE)) %></div>
              <span class="count_bottom">To Date [<%=sCurrFyr %>]</span>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top dark"><i class="glyphicon glyphicon-export orange"></i> EXPENSES PLAN (RM)</span>
              <div class="count orange"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModExpensesPlan.GetSetTODATE)) %></div>
              <span class="count_bottom">To Date [<%=sCurrFyr %>]</span>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top dark"><i class="glyphicon glyphicon-export red"></i> EXPENSES ACTUAL (RM)</span>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel fixed_height_320">
                  <div class="x_title">
                    <h2>Revenue <small>MONTHLY [<%=sCurrFyr %>]</small></h2>
          ...
          <!-- Expenses -->
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel fixed_height_320">
                  <div class="x_title">
                    <h2>Expenses <small>MONTHLY [<%=sCurrFyr %>]</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li><a class="close-link"><i class="fa fa-close"></i></a>
          ...
          <!-- Sales Orders -->
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel fixed_height_390">
                  <div class="x_title">
                    <h2>Sales <small>BY PACKAGE [<%=sCurrFyr %>]</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li><a class="close-link"><i class="fa fa-close"></i></a>
                         ...
                         <table class="table">
                          <thead>
                            <tr>
                              ...
                              <th style="text-align:right"><%=getMonthText(int.Parse(sCurrAMon)) %> (RM)</th>
                              <th style="text-align:right">To Date (RM)</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                              <td><i class="fa fa-square package1"></i></td>
                              <td style="text-align:left">Package 1</td>
                              <td style="text-align:right"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModSalesPackage1ThisMonth.GetSettotalprice)) %></td>
                              <td style="text-align:right"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModSalesPackage1ToDate.GetSettotalprice)) %></td>
                            </tr>
                            <tr>
                              <td><i class="fa fa-square package2"></i></td>
                              <td style="text-align:left">Package 2</td>
                              <td style="text-align:right"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModSalesPackage2ThisMonth.GetSettotalprice)) %></td>
                              <td style="text-align:right"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModSalesPackage2ToDate.GetSettotalprice)) %></td>
                            </tr>
                            <tr>
                              <td><i class="fa fa-square package3"></i></td>
                              <td style="text-align:left">Package 3</td>
                              <td style="text-align:right"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModSalesPackage3ThisMonth.GetSettotalprice)) %></td>
                              <td style="text-align:right"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModSalesPackage3ToDate.GetSettotalprice)) %></td>
                            </tr>
                            <tr>
                              <td><i class="fa fa-square package4"></i></td>
                              <td style="text-align:left">Package 4</td>
                              <td style="text-align:right"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModSalesPackage4ThisMonth.GetSettotalprice)) %></td>
                              <td style="text-align:right"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModSalesPackage4ToDate.GetSettotalprice)) %></td>
                            </tr>
                            <tr>
                              <td><i class="fa fa-square others"></i></td>
                              <td style="text-align:left">Others</td>
                              <td style="text-align:right"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModSalesAllThisMonth.GetSettotalprice-oModSalesPackage4ThisMonth.GetSettotalprice-oModSalesPackage3ThisMonth.GetSettotalprice-oModSalesPackage2ThisMonth.GetSettotalprice-oModSalesPackage1ThisMonth.GetSettotalprice)) %></td>
                              <td style="text-align:right"><%=String.Format("{0:#,##0.00}",Convert.ToDecimal(oModSalesAllToDate.GetSettotalprice-oModSalesPackage4ToDate.GetSettotalprice-oModSalesPackage3ToDate.GetSettotalprice-oModSalesPackage2ToDate.GetSettotalprice-oModSalesPackage1ToDate.GetSettotalprice)) %></td>
                            </tr>
                            <tr>
                              <th scope="row"></th>
          ...
          <!-- /Sales Orders -->
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel fixed_height_390">
                  <div class="x_title">
                    <h2>Sales <small>MONTHLY [<%=sCurrFyr %>]</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
          ...
          <!-- Advert Content Slot -->
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel fixed_height_390">
                  <div class="x_title">
                    <h2>Slot Rental <small>BY ALLOCATION [<%=sCurrFyr %>]</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li><a class="close-link"><i class="fa fa-close"></i></a>
          ...
          <!-- Invoice & Collection -->
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Invoice & Collection <small>TO DATE [<%=sCurrDate %>]</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li><a class="close-link"><i class="fa fa-close"></i></a>
                  ...
                  <div class="x_content">
                    ...
                    <div class="table-responsive">
                          <table id="datatable" class="table table-striped jambo_table">
                            <thead>
                              <tr class="headings">
                                <th class="column-title" style="width:20%;">Customer/ Company Name </th>
                                <th class="column-title" style="width:30%;">Address </th>
                                <th class="column-title" style="width:11%;">Contact </th>
                                <th class="column-title" style="width:13%; text-align:right;">Invoice Amount (RM) </th>
                                <th class="column-title" style="width:13%; text-align:right;">Payment Received (RM)</th>
                                <th class="column-title" style="width:13%; text-align:right;">Pending Payment (RM)</th>
                              </tr>
                            </thead>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Select Year & Month data to update</h4>
                        </div>
    ...
    <script>
        ...
        var data = {
            ...
            datasets: [{
                data: [<%=oModSalesPackage1ToDate.GetSettotalprice %>, <%=oModSalesPackage2ToDate.GetSettotalprice%>, <%=oModSalesPackage3ToDate.GetSettotalprice%>, <%=oModSalesPackage4ToDate.GetSettotalprice%>, <%=oModSalesAllToDate.GetSettotalprice-oModSalesPackage4ToDate.GetSettotalprice-oModSalesPackage3ToDate.GetSettotalprice-oModSalesPackage2ToDate.GetSettotalprice-oModSalesPackage1ToDate.GetSettotalprice %>],
                backgroundColor: [
                  "#5c5c5c",
                  "#27ae60",
                  "#f39c12",
    ...
    <script>
        ...
        echartLine.setOption({
            title: {
                text: 'Slot Allocation',
                subtext: 'MAX: 90 slots/day'
            },
            tooltip: {
                trigger: 'axis'
            },
            ...
            xAxis: [{
                type: 'category',
                boundaryGap: false,
                data: ['<%=oModSlotPlan.GetSetMON01desc%>', '<%=oModSlotPlan.GetSetMON02desc%>', '<%=oModSlotPlan.GetSetMON03desc%>', '<%=oModSlotPlan.GetSetMON04desc%>', '<%=oModSlotPlan.GetSetMON05desc%>', '<%=oModSlotPlan.GetSetMON06desc%>', '<%=oModSlotPlan.GetSetMON07desc%>', '<%=oModSlotPlan.GetSetMON08desc%>', '<%=oModSlotPlan.GetSetMON09desc%>', '<%=oModSlotPlan.GetSetMON10desc%>', '<%=oModSlotPlan.GetSetMON11desc%>', '<%=oModSlotPlan.GetSetMON12desc%>']
            }],
            yAxis: [{
                type: 'value'
            }],
            series: [{
                ...
                data: [<%=oModSlotPlan.GetSetMON01%>, <%=oModSlotPlan.GetSetMON02%>, <%=oModSlotPlan.GetSetMON03%>, <%=oModSlotPlan.GetSetMON04%>, <%=oModSlotPlan.GetSetMON05%>, <%=oModSlotPlan.GetSetMON06%>, <%=oModSlotPlan.GetSetMON07%>, <%=oModSlotPlan.GetSetMON08%>, <%=oModSlotPlan.GetSetMON09%>, <%=oModSlotPlan.GetSetMON10%>, <%=oModSlotPlan.GetSetMON11%>, <%=oModSlotPlan.GetSetMON12%>]
            }, {
                name: 'Occupied',
                type: 'line',
                smooth: true,
                ...
                data: [<%=oModSlotActual.GetSetMON01%>, <%=oModSlotActual.GetSetMON02%>, <%=oModSlotActual.GetSetMON03%>, <%=oModSlotActual.GetSetMON04%>, <%=oModSlotActual.GetSetMON05%>, <%=oModSlotActual.GetSetMON06%>, <%=oModSlotActual.GetSetMON07%>, <%=oModSlotActual.GetSetMON08%>, <%=oModSlotActual.GetSetMON09%>, <%=oModSlotActual.GetSetMON10%>, <%=oModSlotActual.GetSetMON11%>, <%=oModSlotActual.GetSetMON12%>]
            }]
        });
    ...
    <script type="text/javascript">
                function actionclick(action) {
                    ...
                    if ($('#actualyear').val().length == 0)
                    {
                        ...
                        new PNotify({
                            title: 'Alert',
                            text: 'Please select an item in "Year" list!',
                            type: 'warning',
                            styling: 'bootstrap3'
                        });
                    }
                    else if ($('#actualmonth').val().length == 0)
                    {
                        ...
                        new PNotify({
                            title: 'Alert',
                            text: 'Please select an item in "Month" list!',
                            type: 'warning',
                            styling: 'bootstrap3'
                        });
                    }
