<%@ Page Title="" Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" CodeFile="GiveListing.aspx.cs" Inherits="GiveListing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Pesanan Agihan <small>SENARAI</small></h2>
    ...
    <script type="text/javascript">
        ...
        function openaddneworder() {
            var popupWindow = window.open("GiveDetails.aspx?action=ADD", "add_order", "toolbar=0,location=0,status=1,menubar=0,resizable=1,scrollbars=1,width=1000,height=800");
            if (popupWindow == null) {
        ...
        function openeditorder(comp,orderno) {
            var popupWindow = window.open("GiveDetails.aspx?action=OPEN&comp="+comp+"&orderno="+orderno, "open_order", "toolbar=0,location=0,status=1,menubar=0,resizable=1,scrollbars=1,width=1000,height=800");
            if (popupWindow == null) {
                alert("Error: While Launching Session Expiry screen.\nYour browser maybe blocking up Popup windows.\nPlease check your Popup Blocker Settings");
            } else {
                wleft = (screen.width - 1000) / 2;
